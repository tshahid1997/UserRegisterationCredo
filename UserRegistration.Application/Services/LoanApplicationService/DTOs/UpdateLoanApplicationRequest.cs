...
namespace UserRegistration.Application.Services.LoanApplicationService.DTOs
{
    ...
    public class UpdateLoanApplicationRequest : IDto
    {
    ...
    public class UpdateLoanApplicationValidator : FluentValidation.AbstractValidator<UpdateLoanApplicationRequest>
    {
